...
var _ctrl = __webpack_require__(49);
...
var _preact = __webpack_require__(36);

var _components = __webpack_require__(50);

function ui(opts) {
	var data = {};
	(0, _preact.render)((0, _preact.h)(_components.Panel, opts), opts.mount || document.body);
}
...
var _ControlType = __webpack_require__(96);
...
(0, _ControlType.registerTypeCheck)(Panel, 'object', function (val) {
	var score = 0;
...
exports.getComponentForValue = exports.registerTypeChecks = exports.registerTypeCheck = undefined;
...
var registerTypeCheck = exports.registerTypeCheck = function registerTypeCheck(component, types, check) {
  typeChecks.push([Array.isArray(types) ? types : [types], check, component]);
};

var registerTypeChecks = exports.registerTypeChecks = function registerTypeChecks(component, checks) {
  if (checks) checks.forEach(function (_ref) {
...
var getComponentForValue = exports.getComponentForValue = function getComponentForValue(value) {
  var maxScore = 0;
  var conponent = undefined;
  var valueType = typeof value === "undefined" ? "undefined" : (0, _typeof3.default)(value);
  typeChecks.forEach(function (_ref3) {
  ...
  if (conponent === undefined) console.error("Value Type wasn't matched! type: " + valueType + ", value: " + value);
  return conponent;
};
